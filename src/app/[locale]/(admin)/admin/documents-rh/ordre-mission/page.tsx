    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Gestion des ordres de mission</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-12 text-center">
        ...
        <p className="text-gray-400 dark:text-gray-500 max-w-md mx-auto">
          ...
          Vous pourrez bientôt créer et gérer vos ordres de mission ici.
        </p>
      </div>
    </div>
  );
...
export const metadata = {
  ...
  description: 'Gestion des ordres de mission',
};
